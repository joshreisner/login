...
if ($posting) {
	...
	$object_id = db_save('app_objects', false, array('title'=>'News', 'table_name'=>$table, 'show_published'=>1, 'order_by'=>'date', 'sort_by'=>'DESC'));
	...
	$object_id = db_save('app_objects', false, array('title'=>'Pages', 'table_name'=>$table, 'show_published'=>1, 'order_by'=>'precedence'));
	db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'text', 'title'=>'Title', 'field_name'=>'title', 'visibility'=>'list', 'required'=>1));
	db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'url-local', 'title'=>'URL', 'field_name'=>'url', 'visibility'=>'normal', 'related_object_id'=>2, 'required'=>1, 'additional'=>'eg /about/'));
	$parent_id = db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'select', 'title'=>'Parent', 'field_name'=>'parent_id', 'visibility'=>'normal', 'required'=>0, 'related_object_id'=>$object_id));
	db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'textarea', 'title'=>'Content', 'field_name'=>'content', 'visibility'=>'normal', 'required'=>0));
	...
	$object_id = db_save('app_objects', false, array('title'=>'Snippets', 'table_name'=>$table, 'show_published'=>0, 'order_by'=>'title'));
	db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'text', 'title'=>'Title', 'field_name'=>'title', 'visibility'=>'list', 'required'=>1));
	db_save('app_fields', false, array('object_id'=>$object_id, 'type'=>'text', 'title'=>'Content', 'field_name'=>'content', 'visibility'=>'list', 'required'=>0));
	db_save($table, false, array('title'=>'Site Name', 'content'=>'Sample Site'));
	db_save($table, false, array('title'=>'Meta Description', 'content'=>''));
	db_save($table, false, array('title'=>'Meta Keywords', 'content'=>''));
	db_save($table, false, array('title'=>'Copyright', 'content'=>'<p>Copyright ' . date('Y') . ', Your Own Company Here. &#149; info@YourOwnCo.com &#149; site by ' . draw_link('http://www.bureaublank.com/', 'Bureau Blank') . '</p><p>2040 S. Main Street, Suite 243 Everycity, XX 54321</p>'));
